<%-- 
    Document   : fotoprofesor
    Created on : 26 may. 2024, 17:07:50
    Author     : Diman
--%>
...
<html>
    <head>
        ...
        <title>Actualizar Perfil de Profesor</title>
        <style>
            body {
    ...
    <body>
        <div class="container">
            <h2>Actualizar tu perfil de profesor</h2>
            <form action="ProfesorControlador" method="POST" enctype="multipart/form-data" id="form-imagen">
                ...
                <input type="hidden" name="idUsuario" value="${profesor.ID_usuario}">
